...
function Addproduct(){
    ...
    let [pimg, setProductImage] = useState(null);
    let [pDetails, setProductDetails] = useState("");
    ...
    <div id="content-wrapper" className="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div className="container-fluid">
          ...
          <p>Product Details</p>
          <p><textarea  onChange={(ev)=>{setProductDetails(ev.target.value)}} className="form-control" ></textarea></p>
          <p><input onClick={async()=>{
            // console.log(pDetails,pname,pprice,pimg.name)
            ...
            var resp= await fetch("http://localhost:2000/products/add",{
                method:'POST',
                body:fd
            })
